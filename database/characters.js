...
var Character = require('./models/charschema.js');
...
router.get('/all', function (req, res) {
    ...
    User
        ...
        .exec(function (error, doc) {
            ...
            if (error) {
                res.send(error // Or send the doc to the articles in handlebars
                );
            } else {
                res.send(doc);
            }
...
router.post('/add', function (req, res) {
    ...
    req
        ...
        .notEmpty();
    req
        .checkBody('gender', 'Gender is required')
        .notEmpty();
    req
        .checkBody('race', 'Race is required')
        .notEmpty();
    req
    ...
    if (errors) {
        ...
        var newCharacter = new Character({name: name, age: age, gender: gender, race: race, level: level});
