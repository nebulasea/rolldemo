        ...
        $.getJSON("/characters/all", function (req, res) {
            if (req.characters.length > 0) {
                ...
                for (var i = 0; i < charArray.length; i++) {
                    $("#current-char").append("<div data-id='" + charArray[i]._id + "'><h4 class='char-name'>Name: " + charArray[i].name + "</h4><h5 class='char-level'>Level: " + charArray[i].level + "</h5><h5 class='char-age char-age" + charArray[i]._id + " hide'>Age: " + charArray[i].age + "</h5><h5 class='char-gender char-gender" + charArray[i]._id + " hide'>Gender: " + charArray[i].gender + "</h5><h5 class='char-race char-race" + charArray[i]._id + " hide'>Race: " + charArray[i].race + "</h5><button data-id='" + charArray[i]._id + "' class='expand-char expand-char" + charArray[i]._id + "'>Expand</button> <button data-id='" + charArray[i]._id + "' class='close-char close-char" + charArray[i]._id + " hide'>Close</button> <button data-id='" + charArray[i]._id + "' class='delete-char'>Delete</button></div>");
                    console.log(i);
