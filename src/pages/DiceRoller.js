...
const Die = (props) => {
  return (
    <li value={props.value} className="die" id={props.sides} onClick={props.update}>
...
export default class extends Component {
  ...
  // ${mod}`)     total = sum + mod;     console.log(`Total: ${sum} + ${mod} =
  // ${total}`)     return total; }
        ...
        <Row>
          <Col md={3}>
            <div className="output-container">
              <Row>
                <DiceOutput value={this.state.value}/>
